...
<div class="container">
    ...
    <ul class="list-group">
        <li class="list-group-item" v-for="(todo, index) in todos" v-bind:key="todo">
            {{todo.name}}
            <div class="btn-group pull-right" style="font-size:12px;ling-height:1;">
                <button tpye="button" class="btn-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expended="false">
